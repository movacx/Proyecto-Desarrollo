...
class Registro:
    ...
    def _formulario(self):
        tk.Label(self.contenedor, text = '| Registro CoopePuntarenas |', font = ('Arial', 12, 'bold')).grid(row=0,column=0, 
                                                                                                              columnspan=2, 
                                                                                                              pady=(0,20),
                                                                                                              sticky='nswe')
        #______________________________________________________________________________________________________________________
        #Formulario
        tk.Label(self.contenedor, text = 'DNI:').grid(row=1, column = 0, sticky = 'w', pady = 5)
        tk.Label(self.contenedor, text = 'Nombre:').grid(row=2, column = 0, sticky = 'w', pady = 5)
        tk.Label(self.contenedor, text = 'Correo:').grid(row=3, column = 0, sticky = 'w', pady = 5)
        tk.Label(self.contenedor, text = 'Contraseña:').grid(row=4, column = 0, sticky = 'w', pady = 5)
        tk.Label(self.contenedor, text = 'Animal favorito:').grid(row=5, column = 0, sticky = 'w', pady = 5)


    #-==--=-=-==--=-=-=-=-=-=-=-=-==--=-=-=-=-==--=-==--==--=-=-=-=-=-=-=-=-=-=-=-=-=-==--=-=-=-==--==--=-=-=-==--=-=-=-=-=-=-=-=-=-==--=-=-=-=-=-=-=-=-=-=-=-=-==--=-==-
    def _entry(self): #identificador, nombre, correo, passw, rol
        self.entry_dni = tk.Entry(self.contenedor, width = 40)
        self.entry_dni.grid(row = 1, column = 1, sticky = 'we',padx=(10,0))

        self.entry_nombre = tk.Entry(self.contenedor, width = 40)
        ...
        self.entry_password = tk.Entry(self.contenedor)
        self.entry_password.grid(row=4, column = 1, sticky = 'we',padx=(10,0))

        self.entry_ped = tk.Entry(self.contenedor, width = 40)
