...
class RecuperarPass:
    ...
    def _formulario(self):
        tk.Label(self.contenedor, text = '| Recuperación de la cuenta |', font = ('Arial', 14, 'bold')).grid(row=0,column = 0, columnspan = 2, pady = 10)
        ...
        tk.Label(self.contenedor, text = 'Animal Favorito?').grid(row=3, column = 0, sticky = 'w', pady = 5)
    ...
    def _entry(self): #identificador, nombre, correo, passw, rol
        ...
        self.entry_security_guard = tk.Entry(self.contenedor)
